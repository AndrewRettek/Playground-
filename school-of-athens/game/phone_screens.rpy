## phone_screens.rpy - Phone UI screens with warm marble & gold theme (1280x720)

## ===================================================================
## COLOR CONSTANTS - Warm marble & gold palette
## ===================================================================
define PHONE_BG = "#2c2418"
define PHONE_STATUSBAR_BG = "#362d20"
define PHONE_HEADER_BG = "#362d20"
define PHONE_INPUT_BG = "#362d20"
define PHONE_BUBBLE_PLAYER = "#8a6832"
define PHONE_BUBBLE_NPC = "#3d3225"
define PHONE_TEXT_PLAYER = "#fff8ee"
define PHONE_TEXT_NPC = "#ede4d4"
define PHONE_ACCENT = "#c4a265"
define PHONE_NAV_BG = "#231c12"
define PHONE_FRAME_COLOR = "#3a3020"
define PHONE_CARD_TEXT = "#f5efe0"
define PHONE_CARD_PREVIEW = "#a09580"
define PHONE_DIVIDER = "#4a3d2a"
define PHONE_TIMESTAMP = "#f5efe044"
define PHONE_READ_COLOR = "#c4a26566"
...
screen phone_status_bar():
    frame:
        ...
        hbox:
            ...
            text "[get_timestamp()]" size 12 color "#f5efe0aa" xalign 0.5 yalign 0.5
            hbox:
                spacing 4
                xalign 1.0
                yalign 0.5
                text "100%" size 11 color "#f5efe0aa" yalign 0.5
        ...
        vbox:
            ...
            frame:
                ...
                hbox:
                    xfill True
                    yalign 0.5
                    text "Messages" color "#f5efe0" size 22 xalign 0.5 yalign 0.5 bold True outlines [(1, "#00000088", 0, 0)]
        ...
        vbox:
            ...
            frame:
                ...
                hbox:
                    ...
                    vbox:
                        yalign 0.5
                        text session.character_name color "#f5efe0" size 18 font PHONE_FONT_SEMI
                ...
                button:
                    ...
                    yalign 0.5
                    padding (8, 5, 8, 5)
                    background Solid("#8a3040aa")
                    hover_background Solid("#a04050cc")
                    ...
                    vbox:
                        ...
                        for msg in session.messages:
                            if msg.sender == "player":
                                ...
                                ## NPC bubble (left-aligned, with avatar)
                                vbox:
                                    hbox:
                                        spacing 8
                                        xpos 8
        ...
        vbox:
            ...
            frame:
                ...
                hbox:
                    ...
                    text "Contacts" color "#f5efe0" size 22 xalign 0.5 yalign 0.5 bold True
